...
import ResetWasteSuccessModal from "../components/ResetWasteSuccessModal";

export default function ResetWaste() {
  ...
  const handleSearch = () => {
    if (wasteId.trim()) {
      console.log("Searching for waste ID to reset:", wasteId);
      setShowDetails(true);
    }
  };

  const handleResetWaste = () => {
    console.log("Resetting waste:", wasteId, "Notes:", additionalNotes);
            ...
            {!showDetails ? (
              ...
              <>
                ...
                <button
                  ...
                  className={`w-full h-14 rounded-full font-['Epilogue'] font-medium text-base transition-all ${
                    wasteId.trim()
              ...
              // Step 2: Waste Details and Reset
              <>
